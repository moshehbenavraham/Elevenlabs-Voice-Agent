    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="glass-enhanced border-white/20 text-white max-w-md">
        ...
        <div className="space-y-6 mt-6">
          {/* Status Alert */}
          <Alert className={`border ${isConfigured ? 'border-green-500/50 bg-green-500/10' : 'border-yellow-500/50 bg-yellow-500/10'}`}>
          ...
          <div className="space-y-3 p-4 glass rounded-lg">
            ...
            <ol className="space-y-2 text-sm text-white/70">
              <li>1. Create a <code className="px-1 py-0.5 glass rounded">.env</code> file in your project root</li>
              <li>2. Copy the <code className="px-1 py-0.5 glass rounded">.env.example</code> file contents</li>
              <li>3. Replace <code className="px-1 py-0.5 glass rounded">your_agent_id_here</code> with your actual Agent ID</li>
