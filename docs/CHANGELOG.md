...
All notable changes to the Voice-Agent-PuPuPlatter project will be documented in this file.
...
- **Initial Release** - Voice-Agent-PuPuPlatter web application
...
**Maintained by**: Voice-Agent-PuPuPlatter Team
